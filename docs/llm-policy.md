...
This policy defines acceptable and unacceptable use of LLMs and AI agents for open-source work in this repository and projects generated from this template.
...
Projects generated from this template should keep an LLM policy, update it for their own risk profile, and make clear who can approve agent-authored work.
