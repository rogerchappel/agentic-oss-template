...
Every completed task should return a review pack with repo, branch, PR, task, status, summary, commits, files changed, verification, risk level, rollback plan, human decision needed, and next recommended task.
